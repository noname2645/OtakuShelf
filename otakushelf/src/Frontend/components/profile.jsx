          ...
          <div className="story-left">
            ...
            {recentlyWatched.length > 0 ? (
              <div className="recently-watched-layout">
                {/* Featured item */}
                <div className="featured-watch-card">
                  <img
                    src={recentlyWatched[0].image}
                    alt={recentlyWatched[0].title}
                    className="featured-watch-img"
                  />
                  <div className="featured-watch-overlay">
                    <span className="featured-watch-badge">LAST WATCHED</span>
                    <h3 className="featured-watch-title">{recentlyWatched[0].title}</h3>
                  </div>
                </div>
                ...
                {recentlyWatched.length > 1 && (
                  <div className="filmstrip">
                    {recentlyWatched.slice(1).map((anime) => (
                      <div key={anime.id || anime.title} className="filmstrip-card">
                        <img src={anime.image} alt={anime.title} />
                        <div className="filmstrip-title">{anime.title}</div>
                      </div>
                    ))}
                  </div>
                )}
