                ...
                <div className="bottom-button-bar">
                    ...
                    >
                        <input
                            ...
                            onChange={() => handlePageChange('home')}
                        />
                    ...
                    >
                        <input
                            ...
                            name="page"
                            type="radio"
                            checked={activePage === 'list'}
                            onChange={() => handlePageChange('list')}
                        />
                        <svg
                    ...
                    >
                        <input
                            ...
                            name="page"
                            type="radio"
                            checked={activePage === 'AI'}
                            onChange={() => handlePageChange('AI')}
                        />
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 512 512">
