...
- Name: auth.spec.js >> Authentication flows >> registration enforces password policy
- Location: e2e\auth.spec.js:57:7
    ...
    - generic [ref=e9]:
      - generic [ref=e10]:
        ...
        - generic [ref=e15]:
          - generic:
            - img "Password Icon"
          - textbox "Password (min 8 chars, A-Z, 0-9, symbol)" [ref=e16]: short1!
        - generic [ref=e18]:
          - generic:
            - img "Confirm Password Icon"
          - textbox "Confirm your password" [active] [ref=e19]: short1!
